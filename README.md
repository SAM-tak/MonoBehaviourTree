...
## Getting started
The latest version can be installed via [package manager](https://docs.unity3d.com/Manual/upm-ui-giturl.html) using following git URL:<br> ```https://github.com/SAM-tak/MonoBehaviourTree.git?path=Assets/MonoBehaviourTree/Source```
